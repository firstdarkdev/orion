...
import xyz.wagyourtail.unimined.internal.minecraft.patch.bukkit.buildtools.BuildInfo
import xyz.wagyourtail.unimined.internal.minecraft.patch.bukkit.buildtools.parseBuildInfo
import xyz.wagyourtail.unimined.internal.minecraft.patch.bukkit.buildtools.parseVersionInfo
    ...
    val buildInfo: BuildInfo by lazy {
        ...
        if (!buildInfoFile.exists() || project.unimined.forceReload) {
            project.cachingDownload(
                URI.create("https://cache.firstdark.dev/spigot/versions/${rev}.json"),
